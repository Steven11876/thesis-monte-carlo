...
architecture behave of GBM_control_s_axi is
    ...
    constant ADDR_S0_DATA_0                : INTEGER := 16#1c#;
    constant ADDR_S0_DATA_1                : INTEGER := 16#20#;
    constant ADDR_S0_CTRL                  : INTEGER := 16#24#;
    constant ADDR_R_DATA_0                 : INTEGER := 16#28#;
    constant ADDR_R_DATA_1                 : INTEGER := 16#2c#;
    constant ADDR_R_CTRL                   : INTEGER := 16#30#;
    constant ADDR_SIGMA_DATA_0             : INTEGER := 16#34#;
    constant ADDR_SIGMA_DATA_1             : INTEGER := 16#38#;
    constant ADDR_SIGMA_CTRL               : INTEGER := 16#3c#;
    constant ADDR_T_DATA_0                 : INTEGER := 16#40#;
    constant ADDR_T_DATA_1                 : INTEGER := 16#44#;
    constant ADDR_T_CTRL                   : INTEGER := 16#48#;
    constant ADDR_RANDOM_INCREMENTS_DATA_0 : INTEGER := 16#4c#;
    constant ADDR_RANDOM_INCREMENTS_DATA_1 : INTEGER := 16#50#;
    constant ADDR_RANDOM_INCREMENTS_CTRL   : INTEGER := 16#54#;
