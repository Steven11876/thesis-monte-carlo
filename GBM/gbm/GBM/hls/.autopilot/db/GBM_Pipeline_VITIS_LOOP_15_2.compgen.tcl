...
set name GBM_dadd_64ns_64ns_64_6_full_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {dadd} IMPL {fulldsp} LATENCY 5 ALLOW_PRAGMA 1
}
...
set name GBM_dexp_64ns_64ns_64_18_full_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_random_increments \
    op interface \
    ports { random_increments { I 64 vector } } \
} "
}
