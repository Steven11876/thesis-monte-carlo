...
__attribute__((sdx_kernel("GBM", 0))) void GBM(double S[100], double S0, double r, double sigma, double T, double random_increments[100 * (50 -1)] );
# 3 "C:/Users/steve/thesis-monte-carlo/test.c" 2




__attribute__((sdx_kernel("GBM", 0))) void
GBM(double S[100], double S0, double r, double sigma, double T, double random_increments[100 * (50 -1)] ) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=GBM
# 8 "C:/Users/steve/thesis-monte-carlo/test.c"

    double deltat = T / 50;

    VITIS_LOOP_11_1: for (int m = 0; m < 100; m++) {
        S[m] = S0;
    }

    VITIS_LOOP_15_2: for (int m = 0; m < 100; m++) {

        VITIS_LOOP_17_3: for (int j = 0; j < (50 -1); j++) {
