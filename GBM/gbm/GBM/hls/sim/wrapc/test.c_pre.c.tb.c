...
// 
// ==============================================================
# 1 "C:/Users/steve/thesis-monte-carlo/test.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 378 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/steve/thesis-monte-carlo/test.c" 2
...
#pragma pack(pop)
# 2 "C:/Users/steve/thesis-monte-carlo/test.c" 2
...
# 3 "C:/Users/steve/thesis-monte-carlo/test.c" 2




void
GBM(double S[100], double S0, double r, double sigma, double T, double random_increments[100 * (50 -1)] ) {
    double deltat = T / 50;
    ...
    for (int m = 0; m < 100; m++) {
        ...
        for (int j = 0; j < (50 -1); j++) {
            ...
            S[m] *= exp((r - (0.5 * sigma * sigma)) * deltat + sigma * random_increments[m * (50 -1) + j] * sqrt(deltat));
        }
    }
...
extern "C"
#endif
void apatb_GBM_ir(double *, double, double, double, double, double *);
#ifdef __cplusplus
extern "C"
#endif
void GBM_hw_stub(double *S, double S0, double r, double sigma, double T, double *random_increments){
...
extern "C"
#endif
void apatb_GBM_sw(double *S, double S0, double r, double sigma, double T, double *random_increments){
refine_signal_handler();
apatb_GBM_ir(S, S0, r, sigma, T, random_increments);
return ;
}
#endif
# 23 "C:/Users/steve/thesis-monte-carlo/test.c"
