...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "GBM.autotvin.dat"
	set constFileTvOut       "GBM.autotvout.dat"
	set constFileHdlTvIn     "GBM.autohdltvin.dat"
	set constFileHdlTvOut    "GBM.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
