...
module GBM_GBM_Pipeline_VITIS_LOOP_28_395 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [63:0] m_axi_gmem_95_0_WDATA;
output  [7:0] m_axi_gmem_95_0_WSTRB;
...
input  [63:0] m_axi_gmem_95_0_RDATA;
...
input  [60:0] sext_ln28_95;
input  [63:0] sigma;
input  [63:0] sqrt_deltat;
input  [63:0] drift;
output  [63:0] mul204_95_out;
output   mul204_95_out_ap_vld;

reg ap_idle;
reg m_axi_gmem_95_0_RREADY;
reg mul204_95_out_ap_vld;
...
reg   [63:0] gmem_95_addr_read_reg_221;
...
reg   [63:0] mul204_95_fu_62;
reg   [63:0] ap_sig_allocacmp_mul204_95_load;
...
GBM_dadd_64ns_64ns_64_5_full_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dadd_64ns_64ns_64_5_full_dsp_1_U954(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(drift),
...
GBM_dmul_64ns_64ns_64_5_max_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dmul_64ns_64ns_64_5_max_dsp_1_U955(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_116_p0),
    .din1(grp_fu_116_p1),
...
GBM_dexp_64ns_64ns_64_12_full_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dexp_64ns_64ns_64_12_full_dsp_1_U956(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(64'd0),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001_grp1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        gmem_95_addr_read_reg_221 <= m_axi_gmem_95_0_RDATA;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_grp0) & (ap_enable_reg_pp0_iter8 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ap_sig_allocacmp_mul204_95_load = grp_fu_116_p2;
    end else begin
        ap_sig_allocacmp_mul204_95_load = mul204_95_fu_62;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_grp0) & (ap_enable_reg_pp0_iter7 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        grp_fu_116_p0 = ap_sig_allocacmp_mul204_95_load;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage1_11001_grp0) & (ap_loop_exit_ready_pp0_iter7_reg == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln28_reg_217_pp0_iter7_reg == 1'd1))) begin
        mul204_95_out_ap_vld = 1'b1;
    end else begin
        mul204_95_out_ap_vld = 1'b0;
    end
end
...
assign add_ln28_fu_148_p2 = (ap_sig_allocacmp_j_5 + 6'd1);
...
always @ (*) begin
    ap_block_state2_pp0_stage1_iter0_grp1 = ((icmp_ln28_reg_217 == 1'd0) & (m_axi_gmem_95_0_RVALID == 1'b0));
end
...
assign icmp_ln28_fu_142_p2 = ((ap_sig_allocacmp_j_5 == 6'd49) ? 1'b1 : 1'b0);
...
assign m_axi_gmem_95_0_WDATA = 64'd0;

assign m_axi_gmem_95_0_WID = 1'd0;

assign m_axi_gmem_95_0_WLAST = 1'b0;

assign m_axi_gmem_95_0_WSTRB = 8'd0;

assign m_axi_gmem_95_0_WUSER = 1'd0;

assign m_axi_gmem_95_0_WVALID = 1'b0;

assign mul204_95_out = mul204_95_fu_62;

assign random_val_fu_165_p1 = gmem_95_addr_read_reg_221;

endmodule //GBM_GBM_Pipeline_VITIS_LOOP_28_395
