...
module GBM_GBM_Pipeline_VITIS_LOOP_11_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_idle_pp0;
reg   [0:0] icmp_ln12_reg_212;
reg    ap_block_state2_io_grp1;
reg    ap_block_pp0_stage0_subdone;
wire   [0:0] icmp_ln11_fu_107_p2;
...
reg   [191:0] phi_ln12_fu_62;
wire   [191:0] select_ln12_fu_171_p3;
wire    ap_loop_init;
reg   [6:0] m_fu_66;
wire   [6:0] add_ln11_fu_113_p2;
reg   [6:0] ap_sig_allocacmp_m_2;
wire    ap_block_pp0_stage0;
wire   [1:0] trunc_ln11_fu_119_p1;
wire   [127:0] tmp_49_fu_154_p4;
wire   [191:0] tmp_s_fu_164_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln11_fu_107_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln11_fu_107_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_grp1) & (icmp_ln12_reg_212 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (icmp_ln12_reg_212 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln11_fu_113_p2 = (ap_sig_allocacmp_m_2 + 7'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_block_state2_io_grp1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_grp1 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_block_state2_io_grp1));
end

assign ap_block_pp0_stage0_grp1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_block_state2_io_grp1));
end

always @ (*) begin
    ap_block_state2_io_grp1 = ((icmp_ln12_reg_212 == 1'd1) & (m_axi_gmem_0_WREADY == 1'b0));
end
...
assign icmp_ln11_fu_107_p2 = ((ap_sig_allocacmp_m_2 == 7'd100) ? 1'b1 : 1'b0);

assign icmp_ln12_fu_123_p2 = ((trunc_ln11_fu_119_p1 == 2'd3) ? 1'b1 : 1'b0);
...
assign m_axi_gmem_0_WDATA = {{empty}, {phi_ln12_fu_62}};
...
assign select_ln12_fu_171_p3 = ((icmp_ln12_reg_212[0:0] == 1'b1) ? 192'd0 : tmp_s_fu_164_p3);

assign tmp_49_fu_154_p4 = {{phi_ln12_fu_62[191:64]}};

assign tmp_s_fu_164_p3 = {{empty}, {tmp_49_fu_154_p4}};

assign trunc_ln11_fu_119_p1 = ap_sig_allocacmp_m_2[1:0];

endmodule //GBM_GBM_Pipeline_VITIS_LOOP_11_1
