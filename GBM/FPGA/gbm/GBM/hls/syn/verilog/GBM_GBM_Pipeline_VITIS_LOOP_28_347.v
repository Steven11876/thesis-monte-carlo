...
module GBM_GBM_Pipeline_VITIS_LOOP_28_347 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        ap_ready,
        S0,
        m_axi_gmem_47_0_AWVALID,
        m_axi_gmem_47_0_AWREADY,
        m_axi_gmem_47_0_AWADDR,
        m_axi_gmem_47_0_AWID,
        m_axi_gmem_47_0_AWLEN,
        m_axi_gmem_47_0_AWSIZE,
        m_axi_gmem_47_0_AWBURST,
        m_axi_gmem_47_0_AWLOCK,
        m_axi_gmem_47_0_AWCACHE,
        m_axi_gmem_47_0_AWPROT,
        m_axi_gmem_47_0_AWQOS,
        m_axi_gmem_47_0_AWREGION,
        m_axi_gmem_47_0_AWUSER,
        m_axi_gmem_47_0_WVALID,
        m_axi_gmem_47_0_WREADY,
        m_axi_gmem_47_0_WDATA,
        m_axi_gmem_47_0_WSTRB,
        m_axi_gmem_47_0_WLAST,
        m_axi_gmem_47_0_WID,
        m_axi_gmem_47_0_WUSER,
        m_axi_gmem_47_0_ARVALID,
        m_axi_gmem_47_0_ARREADY,
        m_axi_gmem_47_0_ARADDR,
        m_axi_gmem_47_0_ARID,
        m_axi_gmem_47_0_ARLEN,
        m_axi_gmem_47_0_ARSIZE,
        m_axi_gmem_47_0_ARBURST,
        m_axi_gmem_47_0_ARLOCK,
        m_axi_gmem_47_0_ARCACHE,
        m_axi_gmem_47_0_ARPROT,
        m_axi_gmem_47_0_ARQOS,
        m_axi_gmem_47_0_ARREGION,
        m_axi_gmem_47_0_ARUSER,
        m_axi_gmem_47_0_RVALID,
        m_axi_gmem_47_0_RREADY,
        m_axi_gmem_47_0_RDATA,
        m_axi_gmem_47_0_RLAST,
        m_axi_gmem_47_0_RID,
        m_axi_gmem_47_0_RFIFONUM,
        m_axi_gmem_47_0_RUSER,
        m_axi_gmem_47_0_RRESP,
        m_axi_gmem_47_0_BVALID,
        m_axi_gmem_47_0_BREADY,
        m_axi_gmem_47_0_BRESP,
        m_axi_gmem_47_0_BID,
        m_axi_gmem_47_0_BUSER,
        sext_ln28_47,
        sigma,
        sqrt_deltat,
        drift,
        mul204_47_out,
        mul204_47_out_ap_vld
);
...
output   ap_ready;
input  [63:0] S0;
output   m_axi_gmem_47_0_AWVALID;
input   m_axi_gmem_47_0_AWREADY;
output  [63:0] m_axi_gmem_47_0_AWADDR;
output  [0:0] m_axi_gmem_47_0_AWID;
output  [31:0] m_axi_gmem_47_0_AWLEN;
output  [2:0] m_axi_gmem_47_0_AWSIZE;
output  [1:0] m_axi_gmem_47_0_AWBURST;
output  [1:0] m_axi_gmem_47_0_AWLOCK;
output  [3:0] m_axi_gmem_47_0_AWCACHE;
output  [2:0] m_axi_gmem_47_0_AWPROT;
output  [3:0] m_axi_gmem_47_0_AWQOS;
output  [3:0] m_axi_gmem_47_0_AWREGION;
output  [0:0] m_axi_gmem_47_0_AWUSER;
output   m_axi_gmem_47_0_WVALID;
input   m_axi_gmem_47_0_WREADY;
output  [63:0] m_axi_gmem_47_0_WDATA;
output  [7:0] m_axi_gmem_47_0_WSTRB;
output   m_axi_gmem_47_0_WLAST;
output  [0:0] m_axi_gmem_47_0_WID;
output  [0:0] m_axi_gmem_47_0_WUSER;
output   m_axi_gmem_47_0_ARVALID;
input   m_axi_gmem_47_0_ARREADY;
output  [63:0] m_axi_gmem_47_0_ARADDR;
output  [0:0] m_axi_gmem_47_0_ARID;
output  [31:0] m_axi_gmem_47_0_ARLEN;
output  [2:0] m_axi_gmem_47_0_ARSIZE;
output  [1:0] m_axi_gmem_47_0_ARBURST;
output  [1:0] m_axi_gmem_47_0_ARLOCK;
output  [3:0] m_axi_gmem_47_0_ARCACHE;
output  [2:0] m_axi_gmem_47_0_ARPROT;
output  [3:0] m_axi_gmem_47_0_ARQOS;
output  [3:0] m_axi_gmem_47_0_ARREGION;
output  [0:0] m_axi_gmem_47_0_ARUSER;
input   m_axi_gmem_47_0_RVALID;
output   m_axi_gmem_47_0_RREADY;
input  [63:0] m_axi_gmem_47_0_RDATA;
input   m_axi_gmem_47_0_RLAST;
input  [0:0] m_axi_gmem_47_0_RID;
input  [8:0] m_axi_gmem_47_0_RFIFONUM;
input  [0:0] m_axi_gmem_47_0_RUSER;
input  [1:0] m_axi_gmem_47_0_RRESP;
input   m_axi_gmem_47_0_BVALID;
output   m_axi_gmem_47_0_BREADY;
input  [1:0] m_axi_gmem_47_0_BRESP;
input  [0:0] m_axi_gmem_47_0_BID;
input  [0:0] m_axi_gmem_47_0_BUSER;
input  [60:0] sext_ln28_47;
input  [63:0] sigma;
input  [63:0] sqrt_deltat;
input  [63:0] drift;
output  [63:0] mul204_47_out;
output   mul204_47_out_ap_vld;

reg ap_idle;
reg m_axi_gmem_47_0_RREADY;
reg mul204_47_out_ap_vld;
...
reg   [63:0] gmem_47_addr_read_reg_221;
...
reg   [63:0] mul204_47_fu_62;
reg   [63:0] ap_sig_allocacmp_mul204_47_load;
...
GBM_dadd_64ns_64ns_64_5_full_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dadd_64ns_64ns_64_5_full_dsp_1_U474(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(drift),
...
GBM_dmul_64ns_64ns_64_5_max_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dmul_64ns_64ns_64_5_max_dsp_1_U475(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_116_p0),
    .din1(grp_fu_116_p1),
...
GBM_dexp_64ns_64ns_64_12_full_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dexp_64ns_64ns_64_12_full_dsp_1_U476(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(64'd0),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001_grp1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        gmem_47_addr_read_reg_221 <= m_axi_gmem_47_0_RDATA;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_grp0) & (ap_enable_reg_pp0_iter7 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        grp_fu_116_p0 = ap_sig_allocacmp_mul204_47_load;
...
always @ (*) begin
    if (((icmp_ln28_reg_217 == 1'd0) & (ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1_11001_grp1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        m_axi_gmem_47_0_RREADY = 1'b1;
    end else begin
        m_axi_gmem_47_0_RREADY = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage1_11001_grp0) & (ap_loop_exit_ready_pp0_iter7_reg == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln28_reg_217_pp0_iter7_reg == 1'd1))) begin
        mul204_47_out_ap_vld = 1'b1;
    end else begin
        mul204_47_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state2_pp0_stage1_iter0_grp1 = ((icmp_ln28_reg_217 == 1'd0) & (m_axi_gmem_47_0_RVALID == 1'b0));
end
...
assign m_axi_gmem_47_0_ARADDR = 64'd0;

assign m_axi_gmem_47_0_ARBURST = 2'd0;

assign m_axi_gmem_47_0_ARCACHE = 4'd0;

assign m_axi_gmem_47_0_ARID = 1'd0;

assign m_axi_gmem_47_0_ARLEN = 32'd0;

assign m_axi_gmem_47_0_ARLOCK = 2'd0;

assign m_axi_gmem_47_0_ARPROT = 3'd0;

assign m_axi_gmem_47_0_ARQOS = 4'd0;

assign m_axi_gmem_47_0_ARREGION = 4'd0;

assign m_axi_gmem_47_0_ARSIZE = 3'd0;

assign m_axi_gmem_47_0_ARUSER = 1'd0;

assign m_axi_gmem_47_0_ARVALID = 1'b0;

assign m_axi_gmem_47_0_AWADDR = 64'd0;

assign m_axi_gmem_47_0_AWBURST = 2'd0;

assign m_axi_gmem_47_0_AWCACHE = 4'd0;

assign m_axi_gmem_47_0_AWID = 1'd0;

assign m_axi_gmem_47_0_AWLEN = 32'd0;

assign m_axi_gmem_47_0_AWLOCK = 2'd0;

assign m_axi_gmem_47_0_AWPROT = 3'd0;

assign m_axi_gmem_47_0_AWQOS = 4'd0;

assign m_axi_gmem_47_0_AWREGION = 4'd0;

assign m_axi_gmem_47_0_AWSIZE = 3'd0;

assign m_axi_gmem_47_0_AWUSER = 1'd0;

assign m_axi_gmem_47_0_AWVALID = 1'b0;

assign m_axi_gmem_47_0_BREADY = 1'b0;

assign m_axi_gmem_47_0_WDATA = 64'd0;

assign m_axi_gmem_47_0_WID = 1'd0;

assign m_axi_gmem_47_0_WLAST = 1'b0;

assign m_axi_gmem_47_0_WSTRB = 8'd0;

assign m_axi_gmem_47_0_WUSER = 1'd0;

assign m_axi_gmem_47_0_WVALID = 1'b0;

assign mul204_47_out = mul204_47_fu_62;

assign random_val_fu_165_p1 = gmem_47_addr_read_reg_221;

endmodule //GBM_GBM_Pipeline_VITIS_LOOP_28_347
