...
//------------------------Parameter----------------------
`define TV_IN_gmem_0 "../tv/cdatafile/c.GBM.autotvin_gmem_0.dat"
`define TV_OUT_gmem_0 "../tv/rtldatafile/rtl.GBM.autotvout_gmem_0.dat"
 parameter gmem_0_ADDR_BITWIDTH = 32'd 64;
 parameter gmem_0_AWUSER_BITWIDTH = 32'd 1;
 parameter gmem_0_DATA_BITWIDTH = 32'd 64;
...
parameter gmem_0_C_DATA_BITWIDTH = 32'd 64;
parameter gmem_0_transaction_depth = 32'd 50;
parameter gmem_0_mem_depth = 32'd 50;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem_0_mem_depth) begin
                $display ("C:/Users/steve/thesis-monte-carlo/GBM/FPGA/gbm/GBM/hls/sim/verilog/AESL_axi_master_gmem_0.v: Write request address %d exceed AXI master gmem_0 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem_0_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem_0_mem_depth) begin
                $display ("C:/Users/steve/thesis-monte-carlo/GBM/FPGA/gbm/GBM/hls/sim/verilog/AESL_axi_master_gmem_0.v: Read request address %d exceed AXI master gmem_0 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem_0_mem_depth); 
                $finish;
            end
