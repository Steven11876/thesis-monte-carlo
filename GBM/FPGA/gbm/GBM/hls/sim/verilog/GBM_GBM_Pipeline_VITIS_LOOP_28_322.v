...
module GBM_GBM_Pipeline_VITIS_LOOP_28_322 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [63:0] m_axi_gmem_22_0_WDATA;
output  [7:0] m_axi_gmem_22_0_WSTRB;
...
input  [63:0] m_axi_gmem_22_0_RDATA;
...
input  [60:0] sext_ln28_22;
input  [63:0] sigma;
input  [63:0] sqrt_deltat;
input  [63:0] drift;
output  [63:0] mul204_22_out;
output   mul204_22_out_ap_vld;

reg ap_idle;
reg m_axi_gmem_22_0_RREADY;
reg mul204_22_out_ap_vld;
...
reg   [63:0] gmem_22_addr_read_reg_221;
...
reg   [63:0] mul204_22_fu_62;
reg   [63:0] ap_sig_allocacmp_mul204_22_load;
...
GBM_dadd_64ns_64ns_64_5_full_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dadd_64ns_64ns_64_5_full_dsp_1_U224(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(drift),
...
GBM_dmul_64ns_64ns_64_5_max_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dmul_64ns_64ns_64_5_max_dsp_1_U225(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_116_p0),
    .din1(grp_fu_116_p1),
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage1_11001_grp0) & (ap_loop_exit_ready_pp0_iter7_reg == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln28_reg_217_pp0_iter7_reg == 1'd1))) begin
        mul204_22_out_ap_vld = 1'b1;
    end else begin
        mul204_22_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state2_pp0_stage1_iter0_grp1 = ((icmp_ln28_reg_217 == 1'd0) & (m_axi_gmem_22_0_RVALID == 1'b0));
end
...
assign m_axi_gmem_22_0_WDATA = 64'd0;

assign m_axi_gmem_22_0_WID = 1'd0;

assign m_axi_gmem_22_0_WLAST = 1'b0;

assign m_axi_gmem_22_0_WSTRB = 8'd0;

assign m_axi_gmem_22_0_WUSER = 1'd0;

assign m_axi_gmem_22_0_WVALID = 1'b0;

assign mul204_22_out = mul204_22_fu_62;

assign random_val_fu_165_p1 = gmem_22_addr_read_reg_221;

endmodule //GBM_GBM_Pipeline_VITIS_LOOP_28_322
