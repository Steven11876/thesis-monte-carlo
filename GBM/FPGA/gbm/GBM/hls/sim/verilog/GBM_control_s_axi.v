...
localparam
    ...
    ADDR_S_DATA_1                 = 7'h14,
    ADDR_S_CTRL                   = 7'h18,
    ADDR_S0_DATA_0                = 7'h1c,
    ADDR_S0_DATA_1                = 7'h20,
    ADDR_S0_CTRL                  = 7'h24,
    ADDR_R_DATA_0                 = 7'h28,
    ADDR_R_DATA_1                 = 7'h2c,
    ADDR_R_CTRL                   = 7'h30,
    ADDR_SIGMA_DATA_0             = 7'h34,
    ADDR_SIGMA_DATA_1             = 7'h38,
    ADDR_SIGMA_CTRL               = 7'h3c,
    ADDR_T_DATA_0                 = 7'h40,
    ADDR_T_DATA_1                 = 7'h44,
    ADDR_T_CTRL                   = 7'h48,
    ADDR_RANDOM_INCREMENTS_DATA_0 = 7'h4c,
    ADDR_RANDOM_INCREMENTS_DATA_1 = 7'h50,
    ADDR_RANDOM_INCREMENTS_CTRL   = 7'h54,
    WRIDLE                        = 2'd0,
    WRDATA                        = 2'd1,
    WRRESP                        = 2'd2,
    WRRESET                       = 2'd3,
