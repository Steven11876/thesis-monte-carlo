...
module GBM_GBM_Pipeline_VITIS_LOOP_28_310 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [63:0] m_axi_gmem_10_0_WDATA;
output  [7:0] m_axi_gmem_10_0_WSTRB;
...
input  [63:0] m_axi_gmem_10_0_RDATA;
input   m_axi_gmem_10_0_RLAST;
input  [0:0] m_axi_gmem_10_0_RID;
input  [8:0] m_axi_gmem_10_0_RFIFONUM;
...
input  [60:0] sext_ln28_10;
input  [63:0] sigma;
input  [63:0] sqrt_deltat;
input  [63:0] drift;
output  [63:0] mul204_10_out;
output   mul204_10_out_ap_vld;
output  [63:0] grp_fu_7406_p_din0;
output  [63:0] grp_fu_7406_p_din1;
output  [0:0] grp_fu_7406_p_opcode;
input  [63:0] grp_fu_7406_p_dout0;
output   grp_fu_7406_p_ce;
output  [63:0] grp_fu_7411_p_din0;
output  [63:0] grp_fu_7411_p_din1;
input  [63:0] grp_fu_7411_p_dout0;
output   grp_fu_7411_p_ce;

reg ap_idle;
reg m_axi_gmem_10_0_RREADY;
reg mul204_10_out_ap_vld;
...
reg   [63:0] gmem_10_addr_read_reg_221;
...
reg   [63:0] mul204_10_fu_62;
reg   [63:0] ap_sig_allocacmp_mul204_10_load;
...
GBM_dexp_64ns_64ns_64_12_full_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dexp_64ns_64ns_64_12_full_dsp_1_U106(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(64'd0),
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage1_11001_grp0) & (ap_loop_exit_ready_pp0_iter7_reg == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln28_reg_217_pp0_iter7_reg == 1'd1))) begin
        mul204_10_out_ap_vld = 1'b1;
    end else begin
        mul204_10_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state2_pp0_stage1_iter0_grp1 = ((icmp_ln28_reg_217 == 1'd0) & (m_axi_gmem_10_0_RVALID == 1'b0));
end
...
assign grp_fu_7406_p_ce = grp_fu_112_ce;

assign grp_fu_7406_p_din0 = drift;

assign grp_fu_7406_p_din1 = mul16_s_reg_236;

assign grp_fu_7406_p_opcode = 2'd0;

assign grp_fu_7411_p_ce = grp_fu_116_ce;

assign grp_fu_7411_p_din0 = grp_fu_116_p0;

assign grp_fu_7411_p_din1 = grp_fu_116_p1;
...
assign m_axi_gmem_10_0_WDATA = 64'd0;

assign m_axi_gmem_10_0_WID = 1'd0;

assign m_axi_gmem_10_0_WLAST = 1'b0;

assign m_axi_gmem_10_0_WSTRB = 8'd0;

assign m_axi_gmem_10_0_WUSER = 1'd0;

assign m_axi_gmem_10_0_WVALID = 1'b0;

assign mul204_10_out = mul204_10_fu_62;

assign random_val_fu_165_p1 = gmem_10_addr_read_reg_221;

endmodule //GBM_GBM_Pipeline_VITIS_LOOP_28_310
