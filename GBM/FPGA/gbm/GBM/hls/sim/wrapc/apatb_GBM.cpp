...
// wrapc file define:
#define AUTOTB_TVIN_S "../tv/cdatafile/c.GBM.autotvin_S.dat"
#define AUTOTB_TVOUT_S "../tv/cdatafile/c.GBM.autotvout_S.dat"
...
#define AUTOTB_TVIN_random_increments "../tv/cdatafile/c.GBM.autotvin_random_increments.dat"
#define AUTOTB_TVOUT_random_increments "../tv/cdatafile/c.GBM.autotvout_random_increments.dat"
#define AUTOTB_TVIN_gmem "../tv/cdatafile/c.GBM.autotvin_gmem.dat"
#define AUTOTB_TVOUT_gmem "../tv/cdatafile/c.GBM.autotvout_gmem.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_gmem "../tv/rtldatafile/rtl.GBM.autotvout_gmem.dat"
...
extern "C"
void GBM_hw_stub_wrapper(void*, double, double, double, double, void*);

extern "C"
void apatb_GBM_hw(void* __xlx_apatb_param_S, double __xlx_apatb_param_S0, double __xlx_apatb_param_r, double __xlx_apatb_param_sigma, double __xlx_apatb_param_T, void* __xlx_apatb_param_random_increments)
{
  ...
  port1.param = &__xlx_apatb_param_S0;
  ...
  port3.param = &__xlx_apatb_param_sigma;
  ...
  port4.param = &__xlx_apatb_param_T;
  ...
  port5.param = &__xlx_offset_byte_param_random_increments;
  ...
  port6.param = { __xlx_apatb_param_S, __xlx_apatb_param_random_increments };
  port6.mname = { "S", "random_increments" };
  port6.nbytes = { 800, 39200 };
  for (size_t off = 0, i = 0; i < port6.nbytes.size(); ++i) {
    port6.offset.push_back(off);
    off += hls::sim::divide_ceil(port6.nbytes[i], port6.asize);
  }
  __xlx_offset_byte_param_S = port6.offset[0]*32;
  __xlx_offset_byte_param_random_increments = port6.offset[1]*32;
  ...
  try {
    ...
    GBM_hw_stub_wrapper(__xlx_apatb_param_S, __xlx_apatb_param_S0, __xlx_apatb_param_r, __xlx_apatb_param_sigma, __xlx_apatb_param_T, __xlx_apatb_param_random_increments);
