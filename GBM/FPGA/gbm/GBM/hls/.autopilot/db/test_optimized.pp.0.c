...
# 4 "C:/Users/steve/thesis-monte-carlo/GBM/test_optimized.c"
...
#pragma HLS ARRAY_PARTITION variable=random_increments block factor=100
 ...
 double deltat = T / 50;
    ...
    VITIS_LOOP_17_1: for (int m = 0; m < 100; m++) {
#pragma HLS UNROLL factor=100
 S[m] = S0;
    ...
    VITIS_LOOP_24_2: for (int m = 0; m < 100; m++) {
#pragma HLS UNROLL factor=100


 VITIS_LOOP_28_3: for (int j = 0; j < (50 -1); j++) {
