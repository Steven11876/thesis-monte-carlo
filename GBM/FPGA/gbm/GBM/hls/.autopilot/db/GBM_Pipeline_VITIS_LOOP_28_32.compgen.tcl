...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mul204_2_out \
    op interface \
    ports { mul204_2_out { O 64 vector } mul204_2_out_ap_vld { O 1 bit } } \
} "
}
