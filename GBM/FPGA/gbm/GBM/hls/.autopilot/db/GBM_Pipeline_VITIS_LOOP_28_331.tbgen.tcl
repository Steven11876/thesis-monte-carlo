set moduleName GBM_Pipeline_VITIS_LOOP_28_331
set isTopModule 0
...
set cdfgNum 103
set C_modelName {GBM_Pipeline_VITIS_LOOP_28_331}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ S0 double 64 regular  }
	{ gmem_31 int 64 regular {axi_master 0}  }
	{ sext_ln28_31 int 61 regular  }
	{ sigma double 64 regular  }
	{ sqrt_deltat double 64 regular  }
	{ drift double 64 regular  }
	{ mul204_31_out double 64 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "S0", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "gmem_31", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "S_31","offset": { "type": "dynamic","port_name": "S_31","bundle": "control"},"direction": "WRITEONLY"},{"cName": "random_increments_31","offset": { "type": "dynamic","port_name": "random_increments_31","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln28_31", "interface" : "wire", "bitwidth" : 61, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "mul204_31_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ m_axi_gmem_31_0_WDATA sc_out sc_lv 64 signal 1 } 
	{ m_axi_gmem_31_0_WSTRB sc_out sc_lv 8 signal 1 } 
	...
	{ m_axi_gmem_31_0_RDATA sc_in sc_lv 64 signal 1 } 
	{ m_axi_gmem_31_0_RLAST sc_in sc_logic 1 signal 1 } 
	{ m_axi_gmem_31_0_RID sc_in sc_lv 1 signal 1 } 
	{ m_axi_gmem_31_0_RFIFONUM sc_in sc_lv 9 signal 1 } 
	...
	{ sext_ln28_31 sc_in sc_lv 61 signal 2 } 
	{ sigma sc_in sc_lv 64 signal 3 } 
	{ sqrt_deltat sc_in sc_lv 64 signal 4 } 
	{ drift sc_in sc_lv 64 signal 5 } 
	{ mul204_31_out sc_out sc_lv 64 signal 6 } 
	{ mul204_31_out_ap_vld sc_out sc_logic 1 outvld 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "m_axi_gmem_31_0_WDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "gmem_31", "role": "0_WDATA" }} , 
 	{ "name": "m_axi_gmem_31_0_WSTRB", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "gmem_31", "role": "0_WSTRB" }} , 
 	...
 	{ "name": "m_axi_gmem_31_0_RDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "gmem_31", "role": "0_RDATA" }} , 
 	...
 	{ "name": "sext_ln28_31", "direction": "in", "datatype": "sc_lv", "bitwidth":61, "type": "signal", "bundle":{"name": "sext_ln28_31", "role": "default" }} , 
 	...
 	{ "name": "mul204_31_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "mul204_31_out", "role": "default" }} , 
 	{ "name": "mul204_31_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "mul204_31_out", "role": "ap_vld" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		"CDFG" : "GBM_Pipeline_VITIS_LOOP_28_331",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dadd_64ns_64ns_64_5_full_dsp_1_U314", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dmul_64ns_64ns_64_5_max_dsp_1_U315", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dexp_64ns_64ns_64_12_full_dsp_1_U316", "Parent" : "0"},
