...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_gmem_12 \
    op interface \
    ports { m_axi_gmem_12_0_AWVALID { O 1 bit } m_axi_gmem_12_0_AWREADY { I 1 bit } m_axi_gmem_12_0_AWADDR { O 64 vector } m_axi_gmem_12_0_AWID { O 1 vector } m_axi_gmem_12_0_AWLEN { O 32 vector } m_axi_gmem_12_0_AWSIZE { O 3 vector } m_axi_gmem_12_0_AWBURST { O 2 vector } m_axi_gmem_12_0_AWLOCK { O 2 vector } m_axi_gmem_12_0_AWCACHE { O 4 vector } m_axi_gmem_12_0_AWPROT { O 3 vector } m_axi_gmem_12_0_AWQOS { O 4 vector } m_axi_gmem_12_0_AWREGION { O 4 vector } m_axi_gmem_12_0_AWUSER { O 1 vector } m_axi_gmem_12_0_WVALID { O 1 bit } m_axi_gmem_12_0_WREADY { I 1 bit } m_axi_gmem_12_0_WDATA { O 64 vector } m_axi_gmem_12_0_WSTRB { O 8 vector } m_axi_gmem_12_0_WLAST { O 1 bit } m_axi_gmem_12_0_WID { O 1 vector } m_axi_gmem_12_0_WUSER { O 1 vector } m_axi_gmem_12_0_ARVALID { O 1 bit } m_axi_gmem_12_0_ARREADY { I 1 bit } m_axi_gmem_12_0_ARADDR { O 64 vector } m_axi_gmem_12_0_ARID { O 1 vector } m_axi_gmem_12_0_ARLEN { O 32 vector } m_axi_gmem_12_0_ARSIZE { O 3 vector } m_axi_gmem_12_0_ARBURST { O 2 vector } m_axi_gmem_12_0_ARLOCK { O 2 vector } m_axi_gmem_12_0_ARCACHE { O 4 vector } m_axi_gmem_12_0_ARPROT { O 3 vector } m_axi_gmem_12_0_ARQOS { O 4 vector } m_axi_gmem_12_0_ARREGION { O 4 vector } m_axi_gmem_12_0_ARUSER { O 1 vector } m_axi_gmem_12_0_RVALID { I 1 bit } m_axi_gmem_12_0_RREADY { O 1 bit } m_axi_gmem_12_0_RDATA { I 64 vector } m_axi_gmem_12_0_RLAST { I 1 bit } m_axi_gmem_12_0_RID { I 1 vector } m_axi_gmem_12_0_RFIFONUM { I 9 vector } m_axi_gmem_12_0_RUSER { I 1 vector } m_axi_gmem_12_0_RRESP { I 2 vector } m_axi_gmem_12_0_BVALID { I 1 bit } m_axi_gmem_12_0_BREADY { O 1 bit } m_axi_gmem_12_0_BRESP { I 2 vector } m_axi_gmem_12_0_BID { I 1 vector } m_axi_gmem_12_0_BUSER { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln28_12 \
    op interface \
    ports { sext_ln28_12 { I 61 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mul204_12_out \
    op interface \
    ports { mul204_12_out { O 64 vector } mul204_12_out_ap_vld { O 1 bit } } \
} "
}
