set moduleName GBM_Pipeline_VITIS_LOOP_28_315
set isTopModule 0
...
set cdfgNum 103
set C_modelName {GBM_Pipeline_VITIS_LOOP_28_315}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ S0 double 64 regular  }
	{ gmem_15 int 64 regular {axi_master 0}  }
	{ sext_ln28_15 int 61 regular  }
	{ sigma double 64 regular  }
	{ sqrt_deltat double 64 regular  }
	{ drift double 64 regular  }
	{ mul204_15_out double 64 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "S0", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "gmem_15", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "S_15","offset": { "type": "dynamic","port_name": "S_15","bundle": "control"},"direction": "WRITEONLY"},{"cName": "random_increments_15","offset": { "type": "dynamic","port_name": "random_increments_15","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln28_15", "interface" : "wire", "bitwidth" : 61, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "mul204_15_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ m_axi_gmem_15_0_AWVALID sc_out sc_logic 1 signal 1 } 
	{ m_axi_gmem_15_0_AWREADY sc_in sc_logic 1 signal 1 } 
	{ m_axi_gmem_15_0_AWADDR sc_out sc_lv 64 signal 1 } 
	{ m_axi_gmem_15_0_AWID sc_out sc_lv 1 signal 1 } 
	{ m_axi_gmem_15_0_AWLEN sc_out sc_lv 32 signal 1 } 
	{ m_axi_gmem_15_0_AWSIZE sc_out sc_lv 3 signal 1 } 
	{ m_axi_gmem_15_0_AWBURST sc_out sc_lv 2 signal 1 } 
	{ m_axi_gmem_15_0_AWLOCK sc_out sc_lv 2 signal 1 } 
	{ m_axi_gmem_15_0_AWCACHE sc_out sc_lv 4 signal 1 } 
	{ m_axi_gmem_15_0_AWPROT sc_out sc_lv 3 signal 1 } 
	{ m_axi_gmem_15_0_AWQOS sc_out sc_lv 4 signal 1 } 
	{ m_axi_gmem_15_0_AWREGION sc_out sc_lv 4 signal 1 } 
	{ m_axi_gmem_15_0_AWUSER sc_out sc_lv 1 signal 1 } 
	{ m_axi_gmem_15_0_WVALID sc_out sc_logic 1 signal 1 } 
	{ m_axi_gmem_15_0_WREADY sc_in sc_logic 1 signal 1 } 
	{ m_axi_gmem_15_0_WDATA sc_out sc_lv 64 signal 1 } 
	{ m_axi_gmem_15_0_WSTRB sc_out sc_lv 8 signal 1 } 
	{ m_axi_gmem_15_0_WLAST sc_out sc_logic 1 signal 1 } 
	{ m_axi_gmem_15_0_WID sc_out sc_lv 1 signal 1 } 
	{ m_axi_gmem_15_0_WUSER sc_out sc_lv 1 signal 1 } 
	{ m_axi_gmem_15_0_ARVALID sc_out sc_logic 1 signal 1 } 
	{ m_axi_gmem_15_0_ARREADY sc_in sc_logic 1 signal 1 } 
	{ m_axi_gmem_15_0_ARADDR sc_out sc_lv 64 signal 1 } 
	{ m_axi_gmem_15_0_ARID sc_out sc_lv 1 signal 1 } 
	{ m_axi_gmem_15_0_ARLEN sc_out sc_lv 32 signal 1 } 
	{ m_axi_gmem_15_0_ARSIZE sc_out sc_lv 3 signal 1 } 
	{ m_axi_gmem_15_0_ARBURST sc_out sc_lv 2 signal 1 } 
	{ m_axi_gmem_15_0_ARLOCK sc_out sc_lv 2 signal 1 } 
	{ m_axi_gmem_15_0_ARCACHE sc_out sc_lv 4 signal 1 } 
	{ m_axi_gmem_15_0_ARPROT sc_out sc_lv 3 signal 1 } 
	{ m_axi_gmem_15_0_ARQOS sc_out sc_lv 4 signal 1 } 
	{ m_axi_gmem_15_0_ARREGION sc_out sc_lv 4 signal 1 } 
	{ m_axi_gmem_15_0_ARUSER sc_out sc_lv 1 signal 1 } 
	{ m_axi_gmem_15_0_RVALID sc_in sc_logic 1 signal 1 } 
	{ m_axi_gmem_15_0_RREADY sc_out sc_logic 1 signal 1 } 
	{ m_axi_gmem_15_0_RDATA sc_in sc_lv 64 signal 1 } 
	{ m_axi_gmem_15_0_RLAST sc_in sc_logic 1 signal 1 } 
	{ m_axi_gmem_15_0_RID sc_in sc_lv 1 signal 1 } 
	{ m_axi_gmem_15_0_RFIFONUM sc_in sc_lv 9 signal 1 } 
	{ m_axi_gmem_15_0_RUSER sc_in sc_lv 1 signal 1 } 
	{ m_axi_gmem_15_0_RRESP sc_in sc_lv 2 signal 1 } 
	{ m_axi_gmem_15_0_BVALID sc_in sc_logic 1 signal 1 } 
	{ m_axi_gmem_15_0_BREADY sc_out sc_logic 1 signal 1 } 
	{ m_axi_gmem_15_0_BRESP sc_in sc_lv 2 signal 1 } 
	{ m_axi_gmem_15_0_BID sc_in sc_lv 1 signal 1 } 
	{ m_axi_gmem_15_0_BUSER sc_in sc_lv 1 signal 1 } 
	{ sext_ln28_15 sc_in sc_lv 61 signal 2 } 
	{ sigma sc_in sc_lv 64 signal 3 } 
	{ sqrt_deltat sc_in sc_lv 64 signal 4 } 
	{ drift sc_in sc_lv 64 signal 5 } 
	{ mul204_15_out sc_out sc_lv 64 signal 6 } 
	{ mul204_15_out_ap_vld sc_out sc_logic 1 outvld 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "m_axi_gmem_15_0_WDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "gmem_15", "role": "0_WDATA" }} , 
 	{ "name": "m_axi_gmem_15_0_WSTRB", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "gmem_15", "role": "0_WSTRB" }} , 
 	...
 	{ "name": "m_axi_gmem_15_0_RDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "gmem_15", "role": "0_RDATA" }} , 
 	...
 	{ "name": "m_axi_gmem_15_0_RFIFONUM", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "gmem_15", "role": "0_RFIFONUM" }} , 
 	...
 	{ "name": "sext_ln28_15", "direction": "in", "datatype": "sc_lv", "bitwidth":61, "type": "signal", "bundle":{"name": "sext_ln28_15", "role": "default" }} , 
 	...
 	{ "name": "mul204_15_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "mul204_15_out", "role": "default" }} , 
 	{ "name": "mul204_15_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "mul204_15_out", "role": "ap_vld" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		"CDFG" : "GBM_Pipeline_VITIS_LOOP_28_315",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dadd_64ns_64ns_64_5_full_dsp_1_U154", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dmul_64ns_64ns_64_5_max_dsp_1_U155", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dexp_64ns_64ns_64_12_full_dsp_1_U156", "Parent" : "0"},
...
set Spec2ImplPortList { 
	S0 { ap_none {  { S0 in_data 0 64 } } }
	 { m_axi {  { m_axi_gmem_15_0_AWVALID VALID 1 1 }  { m_axi_gmem_15_0_AWREADY READY 0 1 }  { m_axi_gmem_15_0_AWADDR ADDR 1 64 }  { m_axi_gmem_15_0_AWID ID 1 1 }  { m_axi_gmem_15_0_AWLEN SIZE 1 32 }  { m_axi_gmem_15_0_AWSIZE BURST 1 3 }  { m_axi_gmem_15_0_AWBURST LOCK 1 2 }  { m_axi_gmem_15_0_AWLOCK CACHE 1 2 }  { m_axi_gmem_15_0_AWCACHE PROT 1 4 }  { m_axi_gmem_15_0_AWPROT QOS 1 3 }  { m_axi_gmem_15_0_AWQOS REGION 1 4 }  { m_axi_gmem_15_0_AWREGION USER 1 4 }  { m_axi_gmem_15_0_AWUSER DATA 1 1 }  { m_axi_gmem_15_0_WVALID VALID 1 1 }  { m_axi_gmem_15_0_WREADY READY 0 1 }  { m_axi_gmem_15_0_WDATA FIFONUM 1 64 }  { m_axi_gmem_15_0_WSTRB STRB 1 8 }  { m_axi_gmem_15_0_WLAST LAST 1 1 }  { m_axi_gmem_15_0_WID ID 1 1 }  { m_axi_gmem_15_0_WUSER DATA 1 1 }  { m_axi_gmem_15_0_ARVALID VALID 1 1 }  { m_axi_gmem_15_0_ARREADY READY 0 1 }  { m_axi_gmem_15_0_ARADDR ADDR 1 64 }  { m_axi_gmem_15_0_ARID ID 1 1 }  { m_axi_gmem_15_0_ARLEN SIZE 1 32 }  { m_axi_gmem_15_0_ARSIZE BURST 1 3 }  { m_axi_gmem_15_0_ARBURST LOCK 1 2 }  { m_axi_gmem_15_0_ARLOCK CACHE 1 2 }  { m_axi_gmem_15_0_ARCACHE PROT 1 4 }  { m_axi_gmem_15_0_ARPROT QOS 1 3 }  { m_axi_gmem_15_0_ARQOS REGION 1 4 }  { m_axi_gmem_15_0_ARREGION USER 1 4 }  { m_axi_gmem_15_0_ARUSER DATA 1 1 }  { m_axi_gmem_15_0_RVALID VALID 0 1 }  { m_axi_gmem_15_0_RREADY READY 1 1 }  { m_axi_gmem_15_0_RDATA FIFONUM 0 64 }  { m_axi_gmem_15_0_RLAST LAST 0 1 }  { m_axi_gmem_15_0_RID ID 0 1 }  { m_axi_gmem_15_0_RFIFONUM LEN 0 9 }  { m_axi_gmem_15_0_RUSER DATA 0 1 }  { m_axi_gmem_15_0_RRESP RESP 0 2 }  { m_axi_gmem_15_0_BVALID VALID 0 1 }  { m_axi_gmem_15_0_BREADY READY 1 1 }  { m_axi_gmem_15_0_BRESP RESP 0 2 }  { m_axi_gmem_15_0_BID ID 0 1 }  { m_axi_gmem_15_0_BUSER DATA 0 1 } } }
	sext_ln28_15 { ap_none {  { sext_ln28_15 in_data 0 61 } } }
	sigma { ap_none {  { sigma in_data 0 64 } } }
	sqrt_deltat { ap_none {  { sqrt_deltat in_data 0 64 } } }
	drift { ap_none {  { drift in_data 0 64 } } }
	mul204_15_out { ap_vld {  { mul204_15_out out_data 1 64 }  { mul204_15_out_ap_vld out_vld 1 1 } } }
}
