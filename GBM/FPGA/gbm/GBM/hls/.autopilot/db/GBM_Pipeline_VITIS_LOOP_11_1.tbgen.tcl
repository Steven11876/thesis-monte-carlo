set moduleName GBM_Pipeline_VITIS_LOOP_11_1
set isTopModule 0
...
set cdfgNum 5
set C_modelName {GBM_Pipeline_VITIS_LOOP_11_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem int 256 regular {axi_master 1}  }
	{ empty int 64 regular  }
	{ sext_ln11 int 59 regular  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 256, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "S","offset": { "type": "dynamic","port_name": "S","bundle": "control"},"direction": "READWRITE"},{"cName": "random_increments","offset": { "type": "dynamic","port_name": "random_increments","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln11", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln11 sc_in sc_lv 59 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln11", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "sext_ln11", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "GBM_Pipeline_VITIS_LOOP_11_1",
		"Protocol" : "ap_ctrl_hs",
...
set Spec2ImplPortList { 
	...
	sext_ln11 { ap_none {  { sext_ln11 in_data 0 59 } } }
}
