...
__attribute__((sdx_kernel("SABR", 0))) void SABR(double S[100], double V[100], double S0, double r, double sigma_init, double alpha, double beta, double rho, double T, double random_increments[2*100 * (50 -1)]);
# 3 "C:/Users/steve/thesis-monte-carlo/SABR/test_optimized.c" 2

__attribute__((sdx_kernel("SABR", 0))) void SABR(double S[100], double V[100], double S0, double r, double sigma_init, double alpha, double beta, double rho, double T, double random_increments[2*100 * (50 -1)]) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=SABR
# 4 "C:/Users/steve/thesis-monte-carlo/SABR/test_optimized.c"
...
#pragma HLS ARRAY_PARTITION variable=random_increments block factor=100
 ...
 double deltat = T / 50;
    ...
    VITIS_LOOP_21_1: for (int m = 0; m < 100; m++) {
#pragma HLS UNROLL factor=100
 S[m] = S0;
    ...
    VITIS_LOOP_28_2: for (int m = 0; m < 100; m++) {
#pragma HLS UNROLL factor=100

 VITIS_LOOP_31_3: for (int j = 0; j < (50 -1); j++) {
#pragma HLS PIPELINE
