...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_gmem_28 \
    op interface \
    ports { m_axi_gmem_28_0_AWVALID { O 1 bit } m_axi_gmem_28_0_AWREADY { I 1 bit } m_axi_gmem_28_0_AWADDR { O 64 vector } m_axi_gmem_28_0_AWID { O 1 vector } m_axi_gmem_28_0_AWLEN { O 32 vector } m_axi_gmem_28_0_AWSIZE { O 3 vector } m_axi_gmem_28_0_AWBURST { O 2 vector } m_axi_gmem_28_0_AWLOCK { O 2 vector } m_axi_gmem_28_0_AWCACHE { O 4 vector } m_axi_gmem_28_0_AWPROT { O 3 vector } m_axi_gmem_28_0_AWQOS { O 4 vector } m_axi_gmem_28_0_AWREGION { O 4 vector } m_axi_gmem_28_0_AWUSER { O 1 vector } m_axi_gmem_28_0_WVALID { O 1 bit } m_axi_gmem_28_0_WREADY { I 1 bit } m_axi_gmem_28_0_WDATA { O 128 vector } m_axi_gmem_28_0_WSTRB { O 16 vector } m_axi_gmem_28_0_WLAST { O 1 bit } m_axi_gmem_28_0_WID { O 1 vector } m_axi_gmem_28_0_WUSER { O 1 vector } m_axi_gmem_28_0_ARVALID { O 1 bit } m_axi_gmem_28_0_ARREADY { I 1 bit } m_axi_gmem_28_0_ARADDR { O 64 vector } m_axi_gmem_28_0_ARID { O 1 vector } m_axi_gmem_28_0_ARLEN { O 32 vector } m_axi_gmem_28_0_ARSIZE { O 3 vector } m_axi_gmem_28_0_ARBURST { O 2 vector } m_axi_gmem_28_0_ARLOCK { O 2 vector } m_axi_gmem_28_0_ARCACHE { O 4 vector } m_axi_gmem_28_0_ARPROT { O 3 vector } m_axi_gmem_28_0_ARQOS { O 4 vector } m_axi_gmem_28_0_ARREGION { O 4 vector } m_axi_gmem_28_0_ARUSER { O 1 vector } m_axi_gmem_28_0_RVALID { I 1 bit } m_axi_gmem_28_0_RREADY { O 1 bit } m_axi_gmem_28_0_RDATA { I 128 vector } m_axi_gmem_28_0_RLAST { I 1 bit } m_axi_gmem_28_0_RID { I 1 vector } m_axi_gmem_28_0_RFIFONUM { I 9 vector } m_axi_gmem_28_0_RUSER { I 1 vector } m_axi_gmem_28_0_RRESP { I 2 vector } m_axi_gmem_28_0_BVALID { I 1 bit } m_axi_gmem_28_0_BREADY { O 1 bit } m_axi_gmem_28_0_BRESP { I 2 vector } m_axi_gmem_28_0_BID { I 1 vector } m_axi_gmem_28_0_BUSER { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { sext_ln31_28 { I 60 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { x_assign_28_out { O 64 vector } x_assign_28_out_ap_vld { O 1 bit } } \
} "
}
