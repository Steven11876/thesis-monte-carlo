...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { sext_ln31_21 { I 60 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { x_assign_21_out { O 64 vector } x_assign_21_out_ap_vld { O 1 bit } } \
} "
}
