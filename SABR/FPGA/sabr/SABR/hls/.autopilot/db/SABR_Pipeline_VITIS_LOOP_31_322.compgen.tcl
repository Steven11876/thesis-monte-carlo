...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { sext_ln31_22 { I 60 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { x_assign_22_out { O 64 vector } x_assign_22_out_ap_vld { O 1 bit } } \
} "
}
