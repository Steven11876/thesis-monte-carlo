...
module SABR_SABR_Pipeline_VITIS_LOOP_31_347 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [127:0] m_axi_gmem_47_0_WDATA;
output  [15:0] m_axi_gmem_47_0_WSTRB;
...
input  [127:0] m_axi_gmem_47_0_RDATA;
...
reg   [63:0] x_assign_47_load_reg_423;
...
wire   [63:0] bitcast_ln40_54_fu_330_p1;
...
reg   [63:0] x_assign_47_fu_104;
reg   [63:0] ap_sig_allocacmp_x_assign_47_load;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln31_fu_285_p2 == 1'd0))) begin
            j_47_fu_112 <= add_ln31_fu_291_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        x_assign_47_fu_104 <= grp_fu_14271_p_dout0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_j = j_47_fu_112;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_grp0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ap_sig_allocacmp_x_assign_47_load = grp_fu_14271_p_dout0;
    end else begin
        ap_sig_allocacmp_x_assign_47_load = x_assign_47_fu_104;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        ...
        grp_fu_229_p0 = x_assign_47_load_reg_423;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        ...
        grp_fu_229_p1 = bitcast_ln40_54_fu_330_p1;
...
always @ (*) begin
    ap_block_state2_pp0_stage1_iter0_grp1 = ((icmp_ln31_reg_419 == 1'd0) & (m_axi_gmem_47_0_RVALID == 1'b0));
end
...
assign bitcast_ln40_54_fu_330_p1 = trunc_ln40_s_reg_434;
...
assign grp_pow_generic_double_s_fu_28633_p_din1 = ap_sig_allocacmp_x_assign_47_load;
...
assign m_axi_gmem_47_0_WDATA = 128'd0;

assign m_axi_gmem_47_0_WID = 1'd0;

assign m_axi_gmem_47_0_WLAST = 1'b0;

assign m_axi_gmem_47_0_WSTRB = 16'd0;
...
assign trunc_ln40_fu_312_p1 = m_axi_gmem_47_0_RDATA[63:0];

assign x_assign_47_out = x_assign_47_fu_104;

endmodule //SABR_SABR_Pipeline_VITIS_LOOP_31_347
