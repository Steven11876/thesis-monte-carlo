...
// 
// ==============================================================
# 1 "C:/Users/steve/thesis-monte-carlo/SABR/test_func.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 378 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/steve/thesis-monte-carlo/SABR/test_func.c" 2
...
# 2 "C:/Users/steve/thesis-monte-carlo/SABR/test_func.c" 2
...
# 3 "C:/Users/steve/thesis-monte-carlo/SABR/test_func.c" 2
...
# 4 "C:/Users/steve/thesis-monte-carlo/SABR/test_func.c" 2
...
extern "C"
#endif
void apatb_SABR_sw(double *, double *, double, double, double, double, double, double, double, double *);
#endif
# 7 "C:/Users/steve/thesis-monte-carlo/SABR/test.h"
...
# 5 "C:/Users/steve/thesis-monte-carlo/SABR/test_func.c" 2


#ifndef HLS_FASTSIM
# 6 "C:/Users/steve/thesis-monte-carlo/SABR/test_func.c"
int main() {
    FILE *fp;
    double S0 = 100.0;
    double r = 0.05;
    double T = 1.0;
    double sigma_init = 0.5;
    double alpha = 0.3;
    double beta = 0.5;
    double rho = 0.3;


    double* random_increments = (double*)malloc(2*100 * (50 -1) * sizeof(double));

    fp = fopen("in.dat", "r");


    for (int i = 0; i < 2*100 * (50 -1); i++) {
        fscanf(fp, "%lf", &random_increments[i]);
    }

    fclose(fp);

    double* S = (double*)malloc(100 * sizeof(double));
    double* V = (double*)malloc(100 * sizeof(double));

    
#ifndef HLS_FASTSIM
#define SABR apatb_SABR_sw
#endif
# 31 "C:/Users/steve/thesis-monte-carlo/SABR/test_func.c"
SABR(S, V, S0, r, sigma_init, alpha, beta, rho, T, random_increments);
#undef SABR
# 31 "C:/Users/steve/thesis-monte-carlo/SABR/test_func.c"

# 41 "C:/Users/steve/thesis-monte-carlo/SABR/test_func.c"
    fp = fopen("out.dat", "w");
...
#endif
# 58 "C:/Users/steve/thesis-monte-carlo/SABR/test_func.c"
