...
// wrapc file define:
#define AUTOTB_TVIN_S "../tv/cdatafile/c.SABR.autotvin_S.dat"
#define AUTOTB_TVOUT_S "../tv/cdatafile/c.SABR.autotvout_S.dat"
#define AUTOTB_TVIN_V "../tv/cdatafile/c.SABR.autotvin_V.dat"
#define AUTOTB_TVOUT_V "../tv/cdatafile/c.SABR.autotvout_V.dat"
...
#define AUTOTB_TVIN_random_increments "../tv/cdatafile/c.SABR.autotvin_random_increments.dat"
#define AUTOTB_TVOUT_random_increments "../tv/cdatafile/c.SABR.autotvout_random_increments.dat"
#define AUTOTB_TVIN_gmem "../tv/cdatafile/c.SABR.autotvin_gmem.dat"
#define AUTOTB_TVOUT_gmem "../tv/cdatafile/c.SABR.autotvout_gmem.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_gmem "../tv/rtldatafile/rtl.SABR.autotvout_gmem.dat"
...
extern "C"
void SABR_hw_stub_wrapper(void*, void*, double, double, double, double, double, double, double, void*);

extern "C"
void apatb_SABR_hw(void* __xlx_apatb_param_S, void* __xlx_apatb_param_V, double __xlx_apatb_param_S0, double __xlx_apatb_param_r, double __xlx_apatb_param_sigma_init, double __xlx_apatb_param_alpha, double __xlx_apatb_param_beta, double __xlx_apatb_param_rho, double __xlx_apatb_param_T, void* __xlx_apatb_param_random_increments)
{
  ...
  port0.param = &__xlx_offset_byte_param_S;
  ...
  port2.param = &__xlx_apatb_param_S0;
  ...
  port4.param = &__xlx_apatb_param_sigma_init;
  ...
  port7.param = &__xlx_apatb_param_rho;
  ...
  port8.param = &__xlx_apatb_param_T;

  hls::sim::Byte<4> __xlx_offset_byte_param_random_increments;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_random_increments),
#endif
  };
  port9.param = &__xlx_offset_byte_param_random_increments;
  ...
  port10.param = { __xlx_apatb_param_S, __xlx_apatb_param_V, __xlx_apatb_param_random_increments };
  port10.mname = { "S", "V", "random_increments" };
  port10.nbytes = { 800, 800, 78400 };
  ...
  __xlx_offset_byte_param_S = port10.offset[0]*32;
  __xlx_offset_byte_param_V = port10.offset[1]*32;
  __xlx_offset_byte_param_random_increments = port10.offset[2]*32;
  ...
  try {
    ...
    SABR_hw_stub_wrapper(__xlx_apatb_param_S, __xlx_apatb_param_V, __xlx_apatb_param_S0, __xlx_apatb_param_r, __xlx_apatb_param_sigma_init, __xlx_apatb_param_alpha, __xlx_apatb_param_beta, __xlx_apatb_param_rho, __xlx_apatb_param_T, __xlx_apatb_param_random_increments);
