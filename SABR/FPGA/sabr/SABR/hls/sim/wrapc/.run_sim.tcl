...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "SABR.autotvin.dat"
	set constFileTvOut       "SABR.autotvout.dat"
	set constFileHdlTvIn     "SABR.autohdltvin.dat"
	set constFileHdlTvOut    "SABR.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
