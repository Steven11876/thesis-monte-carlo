...
module SABR_SABR_Pipeline_VITIS_LOOP_31_386 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        m_axi_gmem_86_0_AWREADY,
        m_axi_gmem_86_0_AWADDR,
        m_axi_gmem_86_0_AWID,
        m_axi_gmem_86_0_AWLEN,
        m_axi_gmem_86_0_AWSIZE,
        m_axi_gmem_86_0_AWBURST,
        m_axi_gmem_86_0_AWLOCK,
        m_axi_gmem_86_0_AWCACHE,
        m_axi_gmem_86_0_AWPROT,
        m_axi_gmem_86_0_AWQOS,
        m_axi_gmem_86_0_AWREGION,
        m_axi_gmem_86_0_AWUSER,
        m_axi_gmem_86_0_WVALID,
        m_axi_gmem_86_0_WREADY,
        m_axi_gmem_86_0_WDATA,
        m_axi_gmem_86_0_WSTRB,
        m_axi_gmem_86_0_WLAST,
        m_axi_gmem_86_0_WID,
        m_axi_gmem_86_0_WUSER,
        m_axi_gmem_86_0_ARVALID,
        m_axi_gmem_86_0_ARREADY,
        m_axi_gmem_86_0_ARADDR,
        m_axi_gmem_86_0_ARID,
        m_axi_gmem_86_0_ARLEN,
        m_axi_gmem_86_0_ARSIZE,
        m_axi_gmem_86_0_ARBURST,
        m_axi_gmem_86_0_ARLOCK,
        m_axi_gmem_86_0_ARCACHE,
        m_axi_gmem_86_0_ARPROT,
        m_axi_gmem_86_0_ARQOS,
        m_axi_gmem_86_0_ARREGION,
        m_axi_gmem_86_0_ARUSER,
        m_axi_gmem_86_0_RVALID,
        m_axi_gmem_86_0_RREADY,
        m_axi_gmem_86_0_RDATA,
        m_axi_gmem_86_0_RLAST,
        m_axi_gmem_86_0_RID,
        m_axi_gmem_86_0_RFIFONUM,
        m_axi_gmem_86_0_RUSER,
        m_axi_gmem_86_0_RRESP,
        m_axi_gmem_86_0_BVALID,
        m_axi_gmem_86_0_BREADY,
        m_axi_gmem_86_0_BRESP,
        m_axi_gmem_86_0_BID,
        m_axi_gmem_86_0_BUSER,
        sext_ln31_86,
        sqrt_deltat,
        rho,
...
input  [63:0] S0;
output   m_axi_gmem_86_0_AWVALID;
input   m_axi_gmem_86_0_AWREADY;
output  [63:0] m_axi_gmem_86_0_AWADDR;
output  [0:0] m_axi_gmem_86_0_AWID;
output  [31:0] m_axi_gmem_86_0_AWLEN;
output  [2:0] m_axi_gmem_86_0_AWSIZE;
output  [1:0] m_axi_gmem_86_0_AWBURST;
output  [1:0] m_axi_gmem_86_0_AWLOCK;
output  [3:0] m_axi_gmem_86_0_AWCACHE;
output  [2:0] m_axi_gmem_86_0_AWPROT;
output  [3:0] m_axi_gmem_86_0_AWQOS;
output  [3:0] m_axi_gmem_86_0_AWREGION;
output  [0:0] m_axi_gmem_86_0_AWUSER;
output   m_axi_gmem_86_0_WVALID;
input   m_axi_gmem_86_0_WREADY;
output  [127:0] m_axi_gmem_86_0_WDATA;
output  [15:0] m_axi_gmem_86_0_WSTRB;
output   m_axi_gmem_86_0_WLAST;
output  [0:0] m_axi_gmem_86_0_WID;
output  [0:0] m_axi_gmem_86_0_WUSER;
output   m_axi_gmem_86_0_ARVALID;
input   m_axi_gmem_86_0_ARREADY;
output  [63:0] m_axi_gmem_86_0_ARADDR;
output  [0:0] m_axi_gmem_86_0_ARID;
output  [31:0] m_axi_gmem_86_0_ARLEN;
output  [2:0] m_axi_gmem_86_0_ARSIZE;
output  [1:0] m_axi_gmem_86_0_ARBURST;
output  [1:0] m_axi_gmem_86_0_ARLOCK;
output  [3:0] m_axi_gmem_86_0_ARCACHE;
output  [2:0] m_axi_gmem_86_0_ARPROT;
output  [3:0] m_axi_gmem_86_0_ARQOS;
output  [3:0] m_axi_gmem_86_0_ARREGION;
output  [0:0] m_axi_gmem_86_0_ARUSER;
input   m_axi_gmem_86_0_RVALID;
output   m_axi_gmem_86_0_RREADY;
input  [127:0] m_axi_gmem_86_0_RDATA;
input   m_axi_gmem_86_0_RLAST;
input  [0:0] m_axi_gmem_86_0_RID;
input  [8:0] m_axi_gmem_86_0_RFIFONUM;
input  [0:0] m_axi_gmem_86_0_RUSER;
input  [1:0] m_axi_gmem_86_0_RRESP;
input   m_axi_gmem_86_0_BVALID;
output   m_axi_gmem_86_0_BREADY;
input  [1:0] m_axi_gmem_86_0_BRESP;
input  [0:0] m_axi_gmem_86_0_BID;
input  [0:0] m_axi_gmem_86_0_BUSER;
input  [59:0] sext_ln31_86;
...
output  [63:0] p_out;
output   p_out_ap_vld;
output  [63:0] x_assign_86_out;
output   x_assign_86_out_ap_vld;
...
reg ap_idle;
reg m_axi_gmem_86_0_RREADY;
reg p_out_ap_vld;
reg x_assign_86_out_ap_vld;
...
reg   [63:0] x_assign_86_load_reg_423;
...
wire   [63:0] bitcast_ln40_15_fu_330_p1;
...
reg   [63:0] x_assign_86_fu_104;
reg   [63:0] ap_sig_allocacmp_x_assign_86_load;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        x_assign_86_fu_104 <= grp_fu_14271_p_dout0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_grp0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ap_sig_allocacmp_x_assign_86_load = grp_fu_14271_p_dout0;
    end else begin
        ap_sig_allocacmp_x_assign_86_load = x_assign_86_fu_104;
    end
end

always @ (*) begin
    if (((icmp_ln31_reg_419 == 1'd0) & (ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1_grp1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        gmem_86_blk_n_R = m_axi_gmem_86_0_RVALID;
    end else begin
        gmem_86_blk_n_R = 1'b1;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        ...
        grp_fu_229_p0 = x_assign_86_load_reg_423;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6))) begin
        ...
        grp_fu_229_p1 = bitcast_ln40_15_fu_330_p1;
...
always @ (*) begin
    if (((icmp_ln31_reg_419 == 1'd0) & (ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1_11001_grp1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        m_axi_gmem_86_0_RREADY = 1'b1;
    end else begin
        m_axi_gmem_86_0_RREADY = 1'b0;
    end
end
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln31_reg_419 == 1'd1) & (1'b0 == ap_block_pp0_stage10_11001) & (1'b1 == ap_CS_fsm_pp0_stage10))) begin
        x_assign_86_out_ap_vld = 1'b1;
    end else begin
        x_assign_86_out_ap_vld = 1'b0;
    end
end
...
assign add_ln31_fu_291_p2 = (ap_sig_allocacmp_j_14 + 6'd1);
...
always @ (*) begin
    ap_block_state2_pp0_stage1_iter0_grp1 = ((icmp_ln31_reg_419 == 1'd0) & (m_axi_gmem_86_0_RVALID == 1'b0));
end
...
assign bitcast_ln40_15_fu_330_p1 = trunc_ln40_s_reg_434;
...
assign grp_pow_generic_double_s_fu_28633_p_din1 = ap_sig_allocacmp_x_assign_86_load;
...
assign icmp_ln31_fu_285_p2 = ((ap_sig_allocacmp_j_14 == 6'd49) ? 1'b1 : 1'b0);

assign m_axi_gmem_86_0_ARADDR = 64'd0;

assign m_axi_gmem_86_0_ARBURST = 2'd0;

assign m_axi_gmem_86_0_ARCACHE = 4'd0;

assign m_axi_gmem_86_0_ARID = 1'd0;

assign m_axi_gmem_86_0_ARLEN = 32'd0;

assign m_axi_gmem_86_0_ARLOCK = 2'd0;

assign m_axi_gmem_86_0_ARPROT = 3'd0;

assign m_axi_gmem_86_0_ARQOS = 4'd0;

assign m_axi_gmem_86_0_ARREGION = 4'd0;

assign m_axi_gmem_86_0_ARSIZE = 3'd0;

assign m_axi_gmem_86_0_ARUSER = 1'd0;

assign m_axi_gmem_86_0_ARVALID = 1'b0;

assign m_axi_gmem_86_0_AWADDR = 64'd0;

assign m_axi_gmem_86_0_AWBURST = 2'd0;

assign m_axi_gmem_86_0_AWCACHE = 4'd0;

assign m_axi_gmem_86_0_AWID = 1'd0;

assign m_axi_gmem_86_0_AWLEN = 32'd0;

assign m_axi_gmem_86_0_AWLOCK = 2'd0;

assign m_axi_gmem_86_0_AWPROT = 3'd0;

assign m_axi_gmem_86_0_AWQOS = 4'd0;

assign m_axi_gmem_86_0_AWREGION = 4'd0;

assign m_axi_gmem_86_0_AWSIZE = 3'd0;

assign m_axi_gmem_86_0_AWUSER = 1'd0;

assign m_axi_gmem_86_0_AWVALID = 1'b0;

assign m_axi_gmem_86_0_BREADY = 1'b0;

assign m_axi_gmem_86_0_WDATA = 128'd0;

assign m_axi_gmem_86_0_WID = 1'd0;

assign m_axi_gmem_86_0_WLAST = 1'b0;

assign m_axi_gmem_86_0_WSTRB = 16'd0;

assign m_axi_gmem_86_0_WUSER = 1'd0;

assign m_axi_gmem_86_0_WVALID = 1'b0;

assign p_out = empty_fu_108;

assign trunc_ln40_fu_312_p1 = m_axi_gmem_86_0_RDATA[63:0];

assign x_assign_86_out = x_assign_86_fu_104;

endmodule //SABR_SABR_Pipeline_VITIS_LOOP_31_386
