...
module SABR_SABR_Pipeline_VITIS_LOOP_31_328 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [127:0] m_axi_gmem_28_0_WDATA;
output  [15:0] m_axi_gmem_28_0_WSTRB;
...
input  [127:0] m_axi_gmem_28_0_RDATA;
input   m_axi_gmem_28_0_RLAST;
input  [0:0] m_axi_gmem_28_0_RID;
input  [8:0] m_axi_gmem_28_0_RFIFONUM;
...
reg   [63:0] x_assign_28_load_reg_423;
...
wire   [63:0] bitcast_ln40_56_fu_326_p1;
...
reg   [63:0] x_assign_28_fu_104;
reg   [63:0] ap_sig_allocacmp_x_assign_28_load;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001_grp1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        trunc_ln40_s_reg_434 <= {{m_axi_gmem_28_0_RDATA[127:64]}};
    end
end
...
always @ (*) begin
    ap_block_state2_pp0_stage1_iter0_grp1 = ((icmp_ln31_reg_419 == 1'd0) & (m_axi_gmem_28_0_RVALID == 1'b0));
end
...
assign bitcast_ln40_56_fu_326_p1 = trunc_ln40_reg_429;
...
assign grp_pow_generic_double_s_fu_28633_p_din1 = ap_sig_allocacmp_x_assign_28_load;
...
assign m_axi_gmem_28_0_WDATA = 128'd0;

assign m_axi_gmem_28_0_WID = 1'd0;

assign m_axi_gmem_28_0_WLAST = 1'b0;

assign m_axi_gmem_28_0_WSTRB = 16'd0;
...
assign trunc_ln40_fu_312_p1 = m_axi_gmem_28_0_RDATA[63:0];

assign x_assign_28_out = x_assign_28_fu_104;

endmodule //SABR_SABR_Pipeline_VITIS_LOOP_31_328
