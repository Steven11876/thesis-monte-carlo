...
#pragma pack(push,_CRT_PACKING)
# 119 "C:/Xilinx/Vitis/2024.2/tps/mingw/10.0.0/win64.o/nt/x86_64-w64-mingw32/include/math.h" 3
...
# 1580 "C:/Xilinx/Vitis/2024.2/tps/mingw/10.0.0/win64.o/nt/x86_64-w64-mingw32/include/math.h" 3
#pragma pack(pop)
...
extern "C"
#endif
void apatb_SABR_ir(double *, double *, double, double, double, double, double, double, double, double *);
#ifdef __cplusplus
extern "C"
#endif
void SABR_hw_stub(double *S, double *V, double S0, double r, double sigma_init, double alpha, double beta, double rho, double T, double *random_increments){
...
extern "C"
#endif
void apatb_SABR_sw(double *S, double *V, double S0, double r, double sigma_init, double alpha, double beta, double rho, double T, double *random_increments){
refine_signal_handler();
apatb_SABR_ir(S, V, S0, r, sigma_init, alpha, beta, rho, T, random_increments);
return ;
}
#endif
# 29 "C:/Users/steve/thesis-monte-carlo/SABR/test.c"
