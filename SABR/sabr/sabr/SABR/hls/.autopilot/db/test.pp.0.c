# 1 "C:/Users/steve/thesis-monte-carlo/SABR/test.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 360 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "C:/Users/steve/thesis-monte-carlo/SABR/test.c" 2
# 1 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\assert.h" 1 3
# 15 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\assert.h" 3
...
#pragma pack(pop)
# 16 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\assert.h" 2 3
# 26 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\assert.h" 3
...
# 40 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\assert.h" 3
...
# 2 "C:/Users/steve/thesis-monte-carlo/SABR/test.c" 2
...
# 379 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdlib.h" 3
...
# 3 "C:/Users/steve/thesis-monte-carlo/SABR/test.c" 2
...
#pragma pack(push,_CRT_PACKING)
# 119 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\math.h" 3
...
# 1581 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\math.h" 3
#pragma pack(pop)
# 4 "C:/Users/steve/thesis-monte-carlo/SABR/test.c" 2
...
# 5 "C:/Users/steve/thesis-monte-carlo/SABR/test.c" 2




__attribute__((sdx_kernel("SABR", 0))) void
SABR(double S[100], double V[100], double S0, double r, double sigma_init, double alpha, double beta, double rho, double T, double random_increments[2*100 * (50 -1)] ) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=SABR
# 10 "C:/Users/steve/thesis-monte-carlo/SABR/test.c"

    double deltat = T / 50;
    VITIS_LOOP_12_1: for (int m = 0; m < 100; m++) {
        S[m] = S0;
        V[m] = sigma_init;
    }

    VITIS_LOOP_17_2: for (int m = 0; m < 100; m++) {

        VITIS_LOOP_19_3: for (int j = 0; j < (50 -1); j++) {

            double z1 = random_increments[2*m * (50 -1) + 2*j]* sqrt(deltat);
            double z2 = rho*z1 + sqrt(1-rho*rho) * random_increments[2*m * (50 -1) + 2*j+1]* sqrt(deltat);
